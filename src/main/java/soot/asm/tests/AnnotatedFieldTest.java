 ...
 *
 */
public class AnnotatedFieldTest  extends AbstractCacheSrcTest{
	 ...
	 public static void genExampleInput(ClassWriter cw) {
		...
		cw.visit(V1_8, ACC_PUBLIC + ACC_SUPER, "AnnotatedFieldGenerated",
	...
	protected String getTargetClass() {
		return "soot.asm.tests.targets.AnnotatedField";
	}
