 ...
 *
 */
public class CompareArithmeticInstructions2Test extends AbstractCacheSrcTest {
	...
	cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER,
        		"CompareArithmeticInstructions2Generated",
    ...
    protected String getTargetClass() {
        return "soot.asm.tests.targets.CompareArithmeticInstructions2";
    }
