 ...
 *
 */
public class AnnotatedAnnotatedClassTest  extends AbstractCacheSrcTest{
    ...
    public static void genExampleInput(ClassWriter cw){
		...
		cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, "AnnotatedAnnotatedClassGenerated",
	...
	protected String getTargetClass() {
		return "soot.asm.tests.targets.AnnotatedAnnotatedClass";
	}
