 ...
 *
 * @author Tobias Hamann, Florian Kuebler, Dominik Helm, Lukas Sommer, Kristen Newbury, Kristen Newbury
 *
 */
public class ReturnsTest extends AbstractCacheSrcTest{

    public static void genExampleInput(ClassWriter visitor) {
		MethodVisitor mv;

		visitor.visit(V1_1, ACC_PUBLIC + ACC_SUPER, "ReturnsGenerated", null,
	...
	protected String getTargetClass() {
		return "soot.asm.tests.targets.Returns";
	}
