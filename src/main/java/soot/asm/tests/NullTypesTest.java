 ...
 *
 */
public class NullTypesTest extends AbstractCacheSrcTest{
    
    public static void genExampleInput(ClassWriter cw){
        MethodVisitor mv;

	 cw.visit(V1_1, ACC_PUBLIC + ACC_SUPER, "nullTypesGenerated", null, "java/lang/Object", null);
    ...
    protected String getTargetClass() {
        return "soot.asm.tests.targets.nullTypes";
    }
