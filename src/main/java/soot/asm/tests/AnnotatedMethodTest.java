 ...
 *
 */
public class AnnotatedMethodTest  extends AbstractCacheSrcTest{
	 ...
	 public static void genExampleInput(ClassWriter cw) {
		...
		cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, "AnnotatedMethodGenerated",
	...
	protected String getTargetClass() {
		return "soot.asm.tests.targets.AnnotatedMethod";
	}
