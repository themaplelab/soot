 ...
 *
 */
public class MonitorTest  extends AbstractCacheSrcTest{
    ...
    FieldVisitor fv;
		...
		}
		{
			...
			mv.visitVarInsn(ALOAD, 0);
			mv.visitFieldInsn(GETFIELD, "MonitorGenerated", "o", "Ljava/lang/Object;");
	...
	protected String getTargetClass() {
		return "soot.asm.tests.targets.Monitor";
	}
