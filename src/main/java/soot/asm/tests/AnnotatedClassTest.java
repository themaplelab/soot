 ...
 *
 */
public class AnnotatedClassTest  extends AbstractCacheSrcTest{
	 ...
	 public static void genExampleInput(ClassWriter cw) {
		...
		cw.visit(V1_5, ACC_PUBLIC + ACC_SUPER, "AnnotatedClassGenerated",
	...
	protected String getTargetClass() {
		return "soot.asm.tests.targets.AnnotatedClass";
	}
