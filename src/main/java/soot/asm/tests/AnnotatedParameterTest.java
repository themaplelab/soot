 ...
 *
 */
public class AnnotatedParameterTest  extends AbstractCacheSrcTest{
	 ...
	 public static void genExampleInput(ClassWriter cw) {
		...
		{
		av0 = mv.visitParameterAnnotation(0, "Lsoot/asm/tests/targets/MyTestAnnotation;", true);
		...
		av0.visit("strVal", "1");
		av0.visit("rVal", Type.getType("Lsoot/asm/tests/targets/AnnotatedClass;"));
	...
	protected String getTargetClass() {
		return "soot.asm.tests.targets.AnnotatedParameter";
	}
